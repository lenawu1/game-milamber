...
STUDENT_LIBS = vector list polygon color body scene forces collision physics render compound_body elements terrain level_handlers cJSON
...
LIBS = $(LIB_MATH) $(shell sdl2-config --libs) -lSDL2 -lSDL2_gfx -lSDL2_ttf -lSDL2_image -lSDL2_mixer
...
LIBS = SDL2main.lib SDL2.lib SDL2_gfx.lib SDL2_ttf.lib SDL2_image.lib SDL2_mixer.lib shell32.lib
