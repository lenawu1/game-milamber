...
LIBS = $(LIB_MATH) $(shell sdl2-config --libs) -lSDL2 -lSDL2_gfx -lSDL2_ttf -lSDL2_image
...
LIBS = SDL2main.lib SDL2.lib SDL2_gfx.lib SDL2_ttf.lib SDL2_image.lib shell32.lib
